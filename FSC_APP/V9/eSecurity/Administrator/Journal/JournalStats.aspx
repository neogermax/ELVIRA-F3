<%@ page language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Journal_JournalStats, App_Web_vufzdyku" title="Estadísticas de Operaciones" theme="GattacaAdmin" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rblDistributionGroup" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="Week" Selected="True">Semanal</asp:ListItem>
