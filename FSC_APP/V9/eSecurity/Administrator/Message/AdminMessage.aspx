<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Message_AdminMessage, App_Web_8azofsar" theme="GattacaAdmin" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="White"
        ...
        <tr>
            <td>
                ...
                <uc1:SearchControl ID="search" runat="server" Columns="Id,Código,String;Name,Mensaje,String" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
