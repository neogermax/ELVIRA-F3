<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_UserGroup_addUserGroup, App_Web_ak8a4vjr" theme="GattacaAdmin" %>
                ...
                <table border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="White">
                    <tr>
                        ...
                        <td style="text-align: center">
                            <asp:TextBox ID="txtCodigo" runat="server" Width="200px" MaxLength="15" ></asp:TextBox><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <asp:TextBox ID="txtNombre" runat="server" Width="200px" MaxLength="50" ></asp:TextBox><br />
