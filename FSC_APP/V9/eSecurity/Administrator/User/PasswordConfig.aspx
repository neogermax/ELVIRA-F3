<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_User_PasswordConfig, App_Web_gdo_qmou" theme="GattacaAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: center">
        <table style="width: 70%; text-align: left;">
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblConfBehavior" runat="server" Font-Bold="True" Text="Configurar comportamiento"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvTryNumber" runat="server" ControlToValidate="tbTryNumber"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvUnblockTime" runat="server" ControlToValidate="tbUnblockTime"
                        ErrorMessage="Campo obligatorio" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvNotificationTime" runat="server" ControlToValidate="tbNotificationTime"
                        ErrorMessage="Campo obligatorio" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                <td colspan="3"><hr />
                    <asp:Label ID="lblConfComplexity" runat="server" Font-Bold="True" Text="Configurar complejidad"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvHistoricPasswordNumber" runat="server" ControlToValidate="tbHistoricPasswordNumber"
                        ErrorMessage="Campo obligatorio" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvRequiredMinLength" runat="server" ControlToValidate="tbRequiredMinLength"
                        ErrorMessage="Campo obligatorio" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvRequiredMaxLength" runat="server" ControlToValidate="tbRequiredMaxLength"
                        ErrorMessage="Campo obligatorio" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                <td colspan="3"><hr />
                    <asp:Label ID="lblPasswordComplexity" runat="server" Font-Bold="True" Text="Complejidad de contraseñas"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <br />
                    <asp:Label ID="lblNote" runat="server" Text="Nota: Para aplicar la configuración mínima de complejidad en contraseñas, debe tener dos (2) criterios de obligación mínimos seleccionados"
