            ...
            <td colspan="4">
                <table>
                    <tr>
                        ...
                        <td>
                            <%--<gaia:DateTimePicker ID="txtDateInit" runat="server" FirstDayOfWeek="Monday" HasTimePart="True"
                        ...
                        <td>
                            <%--<gaia:DateTimePicker ID="txtDateFinish" runat="server" FirstDayOfWeek="Monday" HasTimePart="True"
                                CausesValidation="False" Culture="es-CO" Format="yyyy/MM/dd hh:mm tt" HasDropDownButton="False"
                                CalendarWidth="210px" />
                            <gaia:CustomValidator ID="cvDates" runat="server" ControlToValidate="txtDateFinish"
