        ...
        <td colspan="4">
            <table>
                <tr>
                    ...
                    <td class="style8">
                        <%--<gaia:DateTimePicker ID="txtDateFinish" runat="server" FirstDayOfWeek="Monday" HasTimePart="True"
                            CausesValidation="False" Culture="es-CO" Format="yyyy/MM/dd hh:mm tt" HasDropDownButton="False"
                            CalendarWidth="210px" />
                            <gaia:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDateFinish"
                            Display="Dynamic">Debe seleccionar una fecha 
                        inicial</gaia:RequiredFieldValidator>
                        <gaia:CustomValidator ID="cvDates" runat="server" 
                            ControlToValidate="txtDateFinish" 
                            Display="Dynamic">La fecha final debe ser mayor 
                        a la fecha inicial</gaia:CustomValidator>--%>
                    ...
                    <td class="style8">
                        <%--<gaia:DateTimePicker ID="txtCreateDate" runat="server" FirstDayOfWeek="Monday" HasTimePart="True"
                            CausesValidation="False" Culture="es-CO" Format="yyyy/MM/dd hh:mm tt" HasDropDownButton="False"
                            CalendarWidth="210px" />--%>
                                        ...
                                        <asp:Chart ID="chartTPromedioCliente" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Duración Promedio de Codificación por Cliente">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Chart ID="chartEspera" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Tiempo de Espera Promedio para Codificación">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                                <asp:Legend BackColor="Transparent" Docking="Bottom" Enabled="True" Font="Trebuchet MS, 8pt, style=Bold"
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Chart ID="chartQCod" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Cantidad Total de Codificaciones por Cliente">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                                <asp:Legend BackColor="Transparent" Docking="Bottom" Enabled="True" Font="Trebuchet MS, 8pt, style=Bold"
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Chart ID="chartAvgAsistente" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Tiempo Promedio por Asistente por Codificación">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                                <asp:Legend BackColor="Transparent" Docking="Bottom" Enabled="True" Font="Trebuchet MS, 8pt, style=Bold"
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Chart ID="chartEsperaAsistente" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Tiempo promedio de espera para codificación por Asistente">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                                <asp:Legend BackColor="Transparent" Docking="Bottom" Enabled="True" Font="Trebuchet MS, 8pt, style=Bold"
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Chart ID="chartQAsistente" runat="server" BackColor="#D3DFF0" BackGradientStyle="TopBottom"
                                            ...
                                            <Titles>
                                                <asp:Title Font="Trebuchet MS, 12.25pt, style=Bold" ForeColor="26, 59, 105" ShadowColor="32, 0, 0, 0"
                                                    ShadowOffset="3" Text="Q Codificaciones por Asistente">
                                                </asp:Title>
                                            </Titles>
                                            <Legends>
                                                <asp:Legend BackColor="Transparent" Docking="Bottom" Enabled="True" Font="Trebuchet MS, 8pt, style=Bold"
