<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MastePages/WorkFlowIP.Master"
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 175px" class="cssLeftPanel" valign="top" align="left">
					...
					<asp:HyperLink ID="lnkProject" runat="server" Text="Administrador de Proyectos" NavigateUrl="../../../FSC/security/default.aspx" CssClass="cssTreeNode" Font-Bold="True"></asp:HyperLink>
                ...
                <asp:GridView ID="gvTaskList" runat="server" BorderWidth="1px" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ver">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkViewEntryData" runat="server" SkinID="HyperLinkVisited" visible="true" >Solicitud</asp:HyperLink>
                                <asp:HyperLink runat="server" ID="litDocument" NavigateUrl='<%# "WorkItem.aspx?IDActivityInstance=" & Eval("Id") & "&op=show" %>' Target="_blank" visible="False">Solicitud</asp:HyperLink>
                            </ItemTemplate>
