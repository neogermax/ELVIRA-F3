<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MastePages/WorkFlowUser.Master"
                        ...
                        <asp:GridView ID="gvProcessCaseList" runat="server" BorderWidth="1px" PageSize="25"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Nombre del Proceso">
                                    <ItemStyle />
                                    <ItemTemplate>
                                        <a class="lnk" href='<%#Container.DataItem.URLService%>Case=<%#Container.DataItem.Id%>&Form=<%#Container.DataItem.associatedData.EntryData%>&IdRelated=<%=Session("UserID") %>&ClientName=<%=Session("AppClient")%>' >
