...
Public Class IdeaInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.IdeaInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIdeaInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IdeaInventory = New IdeaInventory
        rpt.Site = Me.Site
        Return rpt
    End Function
