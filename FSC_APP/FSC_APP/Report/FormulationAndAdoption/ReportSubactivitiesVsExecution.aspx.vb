...
Imports System.Data
Partial Class Report_FormulationAndAdoption_ReportSubactivitiesVsExecution
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "REPORTE SUBACTIVIDADES VS EJECUCIÓN"
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Dim xwriter As New XmlTextWriter(Server.MapPath("actividadesVsEjecucion.xml"), Nothing)
            ...
            For Each registro As DataRow In dt.Rows
                ...
                dt1 = facade.loadReportSubActivityInformationRegistry(applicationCredentials, registro("IdSubActivity").ToString())
                If dt1.Rows.Count > 0 Then
                    For Each registro1 As DataRow In dt1.Rows
                        xwriter.WriteStartElement("task")

                        xwriter.WriteStartElement("pID")
                        xwriter.WriteString(registro1("IdInformationRegistry").ToString())
                        xwriter.WriteEndElement()

                        xwriter.WriteStartElement("pName")
                        xwriter.WriteString(" - Ejecución")
                        xwriter.WriteEndElement()

                        xwriter.WriteStartElement("pStart")
                        xwriter.WriteString(registro1("BeginDate").ToString())
                        xwriter.WriteEndElement()

                        xwriter.WriteStartElement("pEnd")
                        xwriter.WriteString(registro1("EndDate").ToString())
                        xwriter.WriteEndElement()

                        xwriter.WriteStartElement("pColor")
                        xwriter.WriteString("ff0000")
                        xwriter.WriteEndElement()
...
#Region "Metodos"
    ...
    Public Sub loadComboProject(Optional ByVal type As Boolean = True)
        ...
        Try
            ...
            dvProject.Sort = "ProjectName ASC"
            dtProject = dvProject.ToTable(True, "ProjectCode", "IdProject")

            Me.ddlProject.DataSource = dtProject
            Me.ddlProject.DataValueField = "IdProject"
            Me.ddlProject.DataTextField = "ProjectCode"
