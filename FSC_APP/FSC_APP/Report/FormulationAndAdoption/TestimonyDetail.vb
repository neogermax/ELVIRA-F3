...
Public Class TestimonyDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.TestimonyDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestimonyDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestimonyDetail = New TestimonyDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
