<%@ Page Title="" Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.Report_FormulationAndAdoption_ReportSubactivitiesVsExecution" Codebehind="ReportSubactivitiesVsExecution.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" runat="Server">
    ...
    <script type="text/javascript">
        ...
        if (g) {
            ...
            if (g) {
                JSGantt.parseXML("ActividadesVsEjecucion.xml", g);
                g.Draw();
                g.DrawDependencies();
            }
