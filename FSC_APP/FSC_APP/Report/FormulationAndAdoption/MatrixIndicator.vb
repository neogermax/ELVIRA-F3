...
Public Class MatrixIndicator
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.MatrixIndicator.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatrixIndicator
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatrixIndicator = New MatrixIndicator
        rpt.Site = Me.Site
        Return rpt
    End Function
