...
Public Class StrategicLineDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StrategicLineDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.StrategicLineDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStrategicLineDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StrategicLineDetail = New StrategicLineDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
