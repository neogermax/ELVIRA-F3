...
Partial Class Report_ResearchAndDevelopment_ResultInquest
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "RESULTADO DE ENCUESTAS"
            loadCombosProject()
...
#Region "Metodos"
    ...
    Private Sub LoadReport()
        ...
        Try
            ...
            End If
            miCodigo = Request.Form("ctl00$cphPrincipal$txtCode")
            miEncuesta = Request.Form("ctl00$cphPrincipal$txtInquest")

            'Se ejecuta la instrucción que permite poblar el reporte requerido
            dt = facade.loadReportInquest(applicationCredentials, sIdProject, miCodigo, miEncuesta)

            Dim rd As New ReportDocument
            Dim ds As New DataSet()
            ds.Tables.Add(dt.Copy())
            ds.DataSetName = "ResearchAndDevelopment"
            ds.Tables(0).TableName = "dtReportInquest"

            rd.Load(Server.MapPath("AnswerInquest.rpt"))
            rd.SetDataSource(ds)
