...
Public Class AnswerInquest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.AnswerInquest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnswerInquest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnswerInquest = New AnswerInquest
        rpt.Site = Me.Site
        Return rpt
    End Function
