<%@ Page Title="" Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.Report_ResearchAndDevelopment_ReportProducts" Codebehind="ReportProducts.aspx.vb" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" runat="Server">
    <form id="frm01" name="frm01" method="post" action="ReportProducts.aspx">
    <table>
        <tr>
            <td>
            ...
            <td>
                <asp:Label ID="lblRegistrado" runat="server" Text="Operador:"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtRegistrado" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: center">
                <b>Fecha de registro Producto</b>
            </td>
        </tr>
        <tr>
            <td>
