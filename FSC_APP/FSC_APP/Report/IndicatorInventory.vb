...
Public Class IndicatorInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.IndicatorInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIndicatorInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IndicatorInventory = New IndicatorInventory
        rpt.Site = Me.Site
        Return rpt
    End Function
