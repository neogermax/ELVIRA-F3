...
Public Class StateSummoning
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSC_APP.StateSummoning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStateSummoning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StateSummoning = New StateSummoning
        rpt.Site = Me.Site
        Return rpt
    End Function
