<%@ Page Title="" Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.Report_OperationalPlanning_ProposalList" Codebehind="ProposalList.aspx.vb" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" runat="Server">
    <form id="frm01" name="frm01" method="post" action="ProposalList.aspx">
    <table>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lblOperador" runat="server" Text="Nombre Operador"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtOperador" runat="server"></asp:TextBox>
            </td>
            <td>
                <asp:Label ID="lblEstado" runat="server" Text="Estado Propuesta"></asp:Label>
            </td>
            <td>
