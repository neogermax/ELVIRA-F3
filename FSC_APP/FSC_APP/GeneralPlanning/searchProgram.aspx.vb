...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR PROGRAMA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of ProgramEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of ProgramEntity)
        ...
        Select Case CStr(ViewState("field"))
            ...
            Case "idStrategicLine" : idStrategicLine = CStr(Me.txtSearch.Text)
        ...
        Try
            ' buscar
            search = facade.getProgramList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
