...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR ESTRATÉGIA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of STRATEGYEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of STRATEGYEntity)
        ...
        Dim idmanagment As String = ""
        Dim managmentname As String = ""
        ...
        Select Case CStr(ViewState("field"))
            ...
            Case "idstrategicobjective" : idstrategicobjective = CStr(Me.txtSearch.Text)
            Case "strategicobjectivename" : strategicobjectivename = CStr(Me.txtSearch.Text)
            Case "idmanagment" : idmanagment = CStr(Me.txtSearch.Text)
            Case "managmentname" : managmentname = CStr(Me.txtSearch.Text)
        ...
        Try
            ' buscar
            search = STRATEGY.getList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
