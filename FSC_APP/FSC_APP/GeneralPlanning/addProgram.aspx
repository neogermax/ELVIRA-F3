<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.addProgram" title="addProgram" Codebehind="addProgram.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" Runat="Server">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td> 
                            <asp:Label ID="lblidStrategicLine" runat="server" Text="Linea Estrategica"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblHelpidStrategicLine" runat="server" Text=""></asp:Label>
						</td>
                    </tr>
                    <tr>
                        <td> 
