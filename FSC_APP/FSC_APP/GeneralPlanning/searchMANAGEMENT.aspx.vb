...
Partial Class searchMANAGEMENT
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR GERENCIA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of MANAGEMENTEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of MANAGEMENTEntity)

        ' definirlos objetos
        Dim MANAGEMENT As New MANAGEMENTDALC
        Dim id As String = ""
        ...
        Try
            ' buscar
            search = MANAGEMENT.getList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
