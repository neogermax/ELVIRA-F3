<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.searchStrategicLine" title="searchStrategicLine" Codebehind="searchStrategicLine.aspx.vb" %>
                    ...
                    <tr valign="top">
                        <td>
                            <asp:RadioButtonList ID="rblSearch" runat="server" RepeatDirection="Horizontal">
                                ...
                                <asp:ListItem Value="strategicobjectivename">Objetivo Estratrégico</asp:ListItem>
                        ...
                        <td align="right">
                            ...
                            <asp:DropDownList ID="ddlSort" runat="server">
	                            ...
	                            <asp:ListItem Value="code">Código</asp:ListItem>
	                            <asp:ListItem Value="name">Nombre</asp:ListItem>
	                            <asp:ListItem Value="strategicobjectivename">Objetivo Estratégico</asp:ListItem>
	                            <asp:ListItem Value="managementname">Gerencia</asp:ListItem>
	                            <asp:ListItem Value="enabled">Estado</asp:ListItem>
	                            <asp:ListItem Value="username">Usuario</asp:ListItem>
	                            <asp:ListItem Value="createdate">Fecha Creación</asp:ListItem>
                ...
                <asp:UpdatePanel ID="upData" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
						<asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="100%" PageSize="10">
							<Columns>
		                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="addStrategicLine.aspx?op=edit&id={0}" HeaderText="Operaciones" Text="Editar" />
		                        <asp:BoundField DataField="id" HeaderText="Id" />
		                        <asp:BoundField DataField="code" HeaderText="Código" />
		                        <asp:BoundField DataField="name" HeaderText="Nombre" />
		                        <asp:BoundField DataField="STRATEGICOBJECTIVENAME" HeaderText="Objetivo estratégico" />
