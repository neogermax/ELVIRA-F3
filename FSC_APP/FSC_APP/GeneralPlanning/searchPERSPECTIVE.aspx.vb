...
Partial Class searchPERSPECTIVE
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR PERSPECTIVA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of PERSPECTIVEEntity)
	...
	Protected Sub gvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.Cells(5).Text.ToUpper.Equals("TRUE") Then
                ...
                e.Row.Cells(5).Text = "Habilitado"

            Else

                e.Row.Cells(5).Text = "Deshabilitado"
...
#Region "Metodos"
    ...
    Public Function search() As List(Of PERSPECTIVEEntity)
        ...
        Select Case CStr(ViewState("field"))
            ...
            Case "identerprise" : identerprise = CStr(Me.txtSearch.Text)
            Case "enterprisename" : enterprisename = CStr(Me.txtSearch.Text)
        ...
        Try
            ' buscar
            search = facade.getPerspectiveList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
