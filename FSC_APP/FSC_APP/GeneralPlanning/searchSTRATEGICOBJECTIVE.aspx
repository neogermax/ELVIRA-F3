<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.searchSTRATEGICOBJECTIVE" title="searchSTRATEGICOBJECTIVE" Codebehind="searchSTRATEGICOBJECTIVE.aspx.vb" %>
                    ...
                    <tr valign="top">
                        <td>
                            <asp:RadioButtonList ID="rblSearch" runat="server" RepeatDirection="Horizontal">
                                ...
                                <asp:ListItem Value="year">Año</asp:ListItem>
                                <asp:ListItem Value="perspectivename">Perspectiva</asp:ListItem>
                ...
                <asp:UpdatePanel ID="upData" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
						<asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="100%" PageSize="10">
							<Columns>
		                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="addSTRATEGICOBJECTIVE.aspx?op=edit&id={0}" HeaderText="Operaciones" Text="Editar" />
		                        <asp:BoundField DataField="id" HeaderText="Id" />
		                        <asp:BoundField DataField="code" HeaderText="Código" />
		                        <asp:BoundField DataField="name" HeaderText="Nombre" />
		                        <asp:BoundField DataField="year" HeaderText="Año" />
		                        <asp:BoundField DataField="PERSPECTIVENAME" HeaderText="Perspectiva" />
