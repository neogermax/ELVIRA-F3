<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.addPERSPECTIVE" title="addPERSPECTIVE" Codebehind="addPERSPECTIVE.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" Runat="Server">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlidenterprise" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
