<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.addProgramComponent" title="addProgramComponent" Codebehind="addProgramComponent.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" Runat="Server">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtdescription" runat="server" Width="400px" MaxLength="255" 
                                TextMode="MultiLine"></asp:TextBox>
							<asp:RequiredFieldValidator ID="rfvdescription" runat="server" ControlToValidate="txtdescription" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td> 
                            <asp:Label ID="lblidProgram" runat="server" Text="Programa"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlidProgram" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Label ID="lblHelpidProgram" runat="server" Text=""></asp:Label>
						</td>
                    </tr>
                    <tr>
                        <td> 
