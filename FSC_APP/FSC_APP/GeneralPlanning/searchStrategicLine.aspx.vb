...
Partial Class searchStrategicLine
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR LINEA ESTRATEGICA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of StrategicLineEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of StrategicLineEntity)
        ...
        Try
            ' buscar
            search = facade.getStrategicLineList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
