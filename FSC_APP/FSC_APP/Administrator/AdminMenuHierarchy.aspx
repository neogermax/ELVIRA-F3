<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.Administrator_AdminMenuHierarchy" title="Untitled Page" Codebehind="AdminMenuHierarchy.aspx.vb" %>
                ...
                <tbody>
                    <tr>
                        <td align="left" width="60%">
                            <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">ADMINISTRACION DE JERARQUIA DE MENUS</asp:Label></td>
                        <td align="right">
                            <asp:Label ID="lblMenuName" runat="server" CssClass="cssLabelForm"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <cc1:DoubleListBox ID="dlbMenuHierarchy" runat="server" Width="100%" />
                        </td>
                    </tr>
                    <tr>
