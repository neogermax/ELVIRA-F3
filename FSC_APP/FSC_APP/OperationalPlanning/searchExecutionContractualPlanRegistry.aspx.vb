...
Partial Class searchExecutionContractualPlanRegistry
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR REGISTRO PLAN DE EJECUCIÓN CONTRACTUAL."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of ExecutionContractualPlanRegistryEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of ExecutionContractualPlanRegistryEntity)
        ...
        search = New List(Of ExecutionContractualPlanRegistryEntity)
        ...
        Try
            ' buscar
            search = facade.getExecutionContractualPlanRegistryList(applicationCredentials, _
             id, _
             idlike, _
             iduser, _
             username, _
