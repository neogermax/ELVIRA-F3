...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR CONVOCATORIA."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of SummoningEntity)
    ...
    Protected Sub gvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            ' cargar la url
            DirectCast(e.Row.FindControl("hpProporsal"), HyperLink).NavigateUrl = PublicFunction.getSettingValue("ProposalURL").ToString & "&IdSummoning=" & DirectCast(e.Row.DataItem, SummoningEntity).id.ToString

            'Asignar la url externa de la convocatoria.
            e.Row.Cells(12).Text = PublicFunction.getSettingValue("ProposalURL").ToString & "&IdSummoning=" & DirectCast(e.Row.DataItem, SummoningEntity).id.ToString
...
#Region "Metodos"
    ...
    Public Function search() As List(Of SummoningEntity)
        ...
        Try
            ' buscar
            search = facade.getSummoningList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
