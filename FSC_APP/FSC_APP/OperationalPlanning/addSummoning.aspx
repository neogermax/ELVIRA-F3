<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.addSummoning" title="addSummoning" Codebehind="addSummoning.aspx.vb" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<asp:RequiredFieldValidator ID="rfvbegindate" runat="server" ControlToValidate="txtbegindate" ErrorMessage="*">
							</asp:RequiredFieldValidator>
							<cc1:CalendarExtender ID="cesbegindate" runat="server" TargetControlID="txtbegindate"
                                Format="yyyy/MM/dd">
                            </cc1:CalendarExtender>
                            <asp:CompareValidator ID="cvbegindate" runat="server" ErrorMessage="yyyy/MM/dd" ControlToValidate="txtbegindate"
                    ...
                    <tr>
                        ...
                        <td>
							...
							<asp:RequiredFieldValidator ID="rfvenddate" runat="server" ControlToValidate="txtenddate" ErrorMessage="*"></asp:RequiredFieldValidator>
								<cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtenddate"
                                Format="yyyy/MM/dd">
                            </cc1:CalendarExtender>
                            <asp:CompareValidator ID="cvenddate" runat="server" ErrorMessage="yyyy/MM/dd" ControlToValidate="txtenddate"
                                Operator="DataTypeCheck" SetFocusOnError="True" Type="Date"></asp:CompareValidator>
