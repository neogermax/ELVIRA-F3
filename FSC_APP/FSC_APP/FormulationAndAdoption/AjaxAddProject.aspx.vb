...
Partial Public Class AjaxAddProject
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case action
            ...
            Case "getIdeaProject"
                ...
                searchIdea(ideditar, applicationCredentials)
    ...
    Public Sub searchIdea(ByVal id As Integer, ByVal objApplicationCredentials As Gattaca.Application.Credentials.ApplicationCredentials)
        ...
        sql.Append("select  i.Objective, i.Justification, i.AreaDescription,  i.Results, i.ResultsKnowledgeManagement, i.ResultsInstalledCapacity, i.OtherResults , i.startdate, i.Duration, i.days, i.ideaappliesIVA, i.obligationsoftheparties, i.RiskMitigation, i.RisksIdentified, i.BudgetRoute from idea i where i.id= " & id)
        ...
        If data.Rows.Count > 0 Then
            ...
            If IsDBNull(data.Rows(0)("OtherResults")) = False Then
                ...
                OtherResults = ResultsInstalledCapacity.Replace("""", "\""")
            End If
            objResult &= OtherResults
