...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR OBJETIVO."
...
#Region "Metodos"
    ...
    Public Function search() As List(Of ObjectiveEntity)
        ...
        Try
            ' buscar
            search = facade.getObjectiveList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
