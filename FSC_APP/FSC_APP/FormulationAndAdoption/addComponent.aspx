<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.addComponent" Title="addComponent" Codebehind="addComponent.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlidobjective" runat="server">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvidobjective" runat="server" ControlToValidate="ddlidobjective"
                    ErrorMessage="*"></asp:RequiredFieldValidator>
            </td>
            <td>
            ...
            <td colspan="3">
                <asp:GridView ID="gvVersion" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="addComponent.aspx?op=show&amp;id={0}&consultLastVersion=false" 
