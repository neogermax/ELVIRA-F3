<%@ Page Language="VB" MasterPageFile="~/Master/mpAdmin.master" AutoEventWireup="false" Inherits="FSC_APP.searchComponent" title="searchComponent" Codebehind="searchComponent.aspx.vb" %>
                ...
                <asp:UpdatePanel ID="upData" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
						<asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="100%" PageSize="10">
							<Columns>
		                        <asp:HyperLinkField DataNavigateUrlFields="idkey" DataNavigateUrlFormatString="addComponent.aspx?op=edit&id={0}" HeaderText="Operaciones" Text="Editar" />
