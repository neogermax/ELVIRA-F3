...
Partial Class searchAttachFileFormat
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR FORMATO ARCHIVO ANEXO."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of AttachFileFormatEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of AttachFileFormatEntity)
        ...
        Try
            ' buscar
            search = facade.getAttachFileFormatList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
