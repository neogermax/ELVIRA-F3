...
Partial Class searchDocumentType
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' cargar el titulo
            Session("lblTitle") = "BUSCAR TIPO DOCUMENTO."
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ' definir los objetos
        Dim list As List(Of DocumentTypeEntity)
...
#Region "Metodos"
    ...
    Public Function search() As List(Of DocumentTypeEntity)
        ...
        Try
            ' buscar
            search = facade.getDocumentTypeList(applicationCredentials, _
             id, _
             idlike, _
             code, _
             name, _
