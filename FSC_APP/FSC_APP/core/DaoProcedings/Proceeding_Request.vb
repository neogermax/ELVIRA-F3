...
#Region "funciones"
    ...
    Function ExportProceedingsStart() As String
        ...
        Try
            ...
            _proceedingStar_html = String.Format(_proceedingStar_html, _idproject, _type_request, _strategic_line, _contract_number, _contract_nature, _subscription_year, _number_request, _date_request, _justification, _scope, _suspension, _adition, "12", _others, _risks)
