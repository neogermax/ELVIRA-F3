...
#Region "Campos"
    ...
    Private _riskimpact As Integer
    Private _ocurrenceprobability As Integer
    Private _enabled As Boolean
    Private _iduser As Integer
    Private _createdate As DateTime
    Private _componentlist As List(Of ComponentByRiskEntity)
    ...
    Private _componentelisttext As String
...
#Region "Propiedades"
    ...
    Public Property riskimpact() As Integer
        ...
        End Set
    End Property
    Public Property ocurrenceprobability() As Integer
        Get
    ...
    Public Property createdate() As DateTime
        ...
        End Set
    End Property
    Public Property componentlist() As List(Of ComponentByRiskEntity)
        Get
            Return Me._componentlist
        End Get
        Set(ByVal value As List(Of ComponentByRiskEntity))
            Me._componentlist = value
        End Set
    End Property
    Public Property USERNAME() As String
        ...
        End Set
    End Property
    Public ReadOnly Property COMPONENTLISTTEXT() As String
        Get
            Dim objComponentByRisk As New ComponentByRiskEntity
            Me._componentelisttext = ""
            For Each objComponentByRisk In Me._componentlist
                Me._componentelisttext += objComponentByRisk.COMPONENTNAME & "<br />"
            Next
            Return Me._componentelisttext
        End Get
    End Property
